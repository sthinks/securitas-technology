...
import { BsArrowRightCircleFill, BsChevronDown, BsChevronUp, BsDownload } from "react-icons/bs";
...
export default function SolutionInnerDetailSecond() {
    ...
    return (
        !loading && <>
            ...
            <div className="sec-white-bg">
                ...
                <div>
                    <img src={data.banner} alt={data.meta_title} style={{ width: "100%", height: "auto", display: "block" }} />
                </div>
                <div className="container section-padding">
                    <div className="row">
                ...
                {file.length &&
                    <>
                        <div className="container section-padding">
                            <div className="row">
                                <div className="col-sm-12 col-md-6">
                                    <h4 className="sec-blue">İlgili Dökümanlar</h4>
                                </div>
                                <div className="col-sm-12 col-md-6">
                ...
                }
                {
                    ...
                    <>
                        <div className="container section-padding">
                            <div className="row">
                                <div className="col-sm-12 col-md-6">
                                    <h2 className="sec-blue">Alanında kendini kanıtlamış markalar ile iş birliği yapıyoruz</h2>
                                    {
                                        shown ?
                                ...
                                <div className="col-sm-12 col-md-6">
                                    <div className="container">
                                        <div className="row">
                                            {data.partners?.length && <div></div>}
                                            {data.partners.map((item) => (
                                                <div className="col-sm-12 col-md-4">
                                                    <div className="solution-inner-brands-item">
                                                        <div>
                                                            <p>{item.company}</p>
                                                        </div>
                                                        <div>
